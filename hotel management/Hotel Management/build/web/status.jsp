...
Displaying the rooms currently occupied and selecting the room to be vacated.
--%>
...
<html>
    ...
    margin-left: 50px;
        ...
        <script>
            ...
            function append(but){
                    ...
                    form.setAttribute("action", "update1");
                    ...
                    hiddenField2.setAttribute("name", "ename");
                    hiddenField2.setAttribute("value", '<%=logname%>');
    ...
    <body onload="check();">
         <h3> select a room to check to Checkout : </h3>
        <div class="container">
         <div class="style_1">
            ...
            <fieldset>
                <label style="font-size: 30px;">Employee Name: <%=logname%></label>
                <br>
