...
%>
    ...
    <tr >
        ...
        <a href="\EmployeeDatabase/view/update.jsp?id=<%=rs.getString(3) %>">Edit</a>
         
        <a href="\EmployeeDatabase/delete_d?id=<%=rs.getString(3) %>" onclick="return confirm('Are you sure..?');">Delete</a>
